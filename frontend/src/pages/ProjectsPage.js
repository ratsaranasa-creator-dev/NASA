...
const sampleProjects = [
  {
    id: 1,
    title: 'GARE 12',
    desc: 'Gare de voyageurs de Dembéni - rénovation et accessibilité pour tous.',
    ...
    img: img1,
    budget: '2.5M€',
    fullDescription: "Le projet GARE 12 consiste en la rénovation complète de la gare de voyageurs de Dembéni. L'objectif principal est de moderniser les infrastructures pour les rendre accessibles à toutes les personnes, y compris celles à mobilité réduite. Les travaux incluent la réfection des quais, l'installation d'ascenseurs, la création d'espaces d'attente couverts et climatisés, ainsi que la mise en place d'un système d'information voyageurs en temps réel.",
    objectives: [
      "Mise aux normes d'accessibilité PMR complète",
      "Modernisation du système de signalétique",
      "Création d'un parvis paysager de 2 000 m²",
      "Installation de panneaux solaires sur les toitures"
    ],
    timeline: [
      { phase: "Études et conception", period: "Jan - Mars 2023", done: true },
      { phase: "Travaux de gros œuvre", period: "Avr - Sep 2023", done: true },
      { phase: "Aménagements intérieurs", period: "Oct 2023 - Fév 2024", done: false },
      { phase: "Livraison finale", period: "Mars 2024", done: false }
    ],
    beneficiaries: "15 000+",
    duration: "14 mois",
    manager: "Direction des Infrastructures"
  },
  {
    id: 2,
    title: "Élection du maire",
    desc: 'Soutien aux élus locaux et modernisation des conseils.',
    category: 'Social',
    ...
    img: img2,
    budget: '500K€',
    fullDescription: "Ce projet vise à renforcer la démocratie locale en modernisant les processus électoraux et en améliorant la transparence des conseils municipaux. Il inclut la formation des élus, la numérisation des votes et la création d'une plateforme de participation citoyenne.",
    objectives: [
      "Digitalisation complète du processus électoral",
      "Formation des conseillers municipaux",
      "Création d'une plateforme de transparence",
      "Organisation de consultations citoyennes"
    ],
    timeline: [
      { phase: "Consultation publique", period: "Sep - Nov 2023", done: false },
      { phase: "Mise en place technique", period: "Déc 2023 - Mar 2024", done: false }
    ],
    beneficiaries: "25 000+",
    duration: "8 mois",
    manager: "Service Affaires Générales"
  },
  {
    id: 3,
    title: 'Développement du centre-ville',
    desc: "Réaménagement urbain, espaces verts et mobilité durable.",
    category: 'Urbanisme',
    ...
    img: img3,
    budget: '5.2M€',
    fullDescription: "Un projet ambitieux pour moderniser, embellir et dynamiser le cœur de notre commune. Ce programme comprend la piétonisation de rues stratégiques, la création de nouveaux espaces verts, l'installation de mobilier urbain innovant et la mise en place de pistes cyclables connectées.",
    objectives: [
      "Piétonisation de 3 rues du centre historique",
      "Plantation de 500 arbres et arbustes",
      "Création de 2 km de pistes cyclables",
      "Rénovation de 15 façades patrimoniales"
    ],
    timeline: [
      { phase: "Concertation citoyenne", period: "Jan - Avr 2023", done: true },
      { phase: "Phase 1 : Voirie", period: "Mai - Déc 2023", done: true },
      { phase: "Phase 2 : Espaces verts", period: "Jan - Juin 2024", done: false },
      { phase: "Phase 3 : Mobilier & finitions", period: "Juil - Oct 2024", done: false }
    ],
    beneficiaries: "10 000+",
    duration: "24 mois",
    manager: "Direction de l'Urbanisme"
  },
  {
    id: 4,
    title: 'Parc écologique de Dembéni',
    desc: "Création d'un parc naturel avec sentiers et zones de loisir.",
    ...
    img: img4,
    budget: '1.8M€',
    fullDescription: "Le parc écologique de Dembéni est un espace naturel de 5 hectares dédié à la biodiversité locale et aux loisirs en plein air. Il propose des sentiers de découverte, une zone humide protégée, des aires de jeux pour enfants et un amphithéâtre naturel pour les événements culturels en plein air.",
    objectives: [
      "Préservation de 3 espèces endémiques",
      "Aménagement de 4 km de sentiers balisés",
      "Création d'un jardin botanique pédagogique",
      "Installation d'un système d'irrigation écologique"
    ],
    timeline: [
      { phase: "Études environnementales", period: "Jan - Mar 2022", done: true },
      { phase: "Terrassement et plantations", period: "Avr - Oct 2022", done: true },
      { phase: "Aménagements et équipements", period: "Nov 2022 - Mar 2023", done: true },
      { phase: "Inauguration", period: "15 Octobre 2023", done: true }
    ],
    beneficiaries: "20 000+",
    duration: "18 mois",
    manager: "Service Environnement"
  }
];
